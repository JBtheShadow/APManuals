...
def before_generate_early(world: World, multiworld: MultiWorld, player: int) -> None:
    ...
    if include_shops:
        if shops_master and not shops_life:
            ...
            shops_master = False
            set_option(world, "shops_master", shops_master)
        if not (shops_castele or shops_port or shops_desert or shops_other or shops_dlc):
            logging.warning("Cannot include shops without at least selecting shops for one of the major cities, other shops or DLC ones.")
            logging.warning("Reverting include_shops back to false.")
            include_shops = False

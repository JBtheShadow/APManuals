...
class DataValidation:
    ...
    def preFillCheckIfEnoughItemsForValue(world: World, multiworld: MultiWorld):
        from .Helpers import filter_used_regions, get_items_for_player, get_items_with_value
        ...
        for region in used_regions:
            ...
            for location in region.locations:
                ...
                if "requires" in manualLocation and manualLocation["requires"]:
                    DataValidation._checkLocationRequiresForItemValueWithRegex(
                        values_requested, json.dumps(manualLocation["requires"])
                    )
        ...
        if values_requested:
            ...
            existing_items = [
                ...
                if item.code is not None and ItemClassification.progression in item.classification
            ]

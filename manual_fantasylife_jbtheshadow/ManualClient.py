    ...
    def run_gui(self):
        ...
        class ManualManager(GameManager):
            ...
            def build(self) -> Layout:
                ...
                self.game_bar_text = TextInput(
                    text=self.ctx.suggested_game, size_hint_y=None, height=dp(30), multiline=False, write_tab=False
                )
            ...
            def build_tracker_and_locations_table(self):
                ...
                for location_category in sorted(self.listed_locations.keys()):
                    ...
                    if location_category in victory_categories:
                        ...
                        location_button = TreeViewButton(
                            text=victory_text, size_hint=(None, None), height=30, width=400
                        )
                            ...
                            if (
                                ...
                                for network_item in self.ctx.items_received:
                                    ...
                                    if (
                                        ...
                                        and network_item.item not in self.listed_items[category_name]
                                    ):
                                        item_count = len(
                                            list(i for i in self.ctx.items_received if i.item == network_item.item)
                                        )
                                        item_text = Label(
